...
function ProviderProfile() {
  const defaultProfile = {
    ...
    location: "Kolkata",
    about:
      "Professional service provider on FixKart helping customers with reliable and convenient home services.",
  }
  ...
  useEffect(() => {
    ...
    window.addEventListener("fixkartBookingsUpdated", loadProfileData)
    window.addEventListener(
      "fixkartProviderServicesUpdated",
      loadProfileData
    )
    window.addEventListener("fixkartProfileUpdated", loadProfileData)
  ...
  const ratings = providerBookings.filter(
    (booking) =>
      booking.providerReviewSubmitted &&
      Number(booking.providerRating) > 0
  )

  const totalRating = ratings.reduce(
    (sum, booking) => sum + Number(booking.providerRating),
    0
  )
  ...
  const handleSave = () => {
    ...
    window.dispatchEvent(new Event("fixkartProfileUpdated"))
  }
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 md:p-8">
            ...
            <div className="mt-6">
              ...
              <p className="text-xs text-slate-500 mt-3">
                Manage your services from Service Setup.
              </p>
            </div>
